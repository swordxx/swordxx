...
zText4::zText4(const char *ipath, const char *iname, const char *idesc, int iblockType, SWCompress *icomp, TextEncoding enc, SWTextDirection dir, SWTextMarkup mark, const char *ilang, const char *versification)
