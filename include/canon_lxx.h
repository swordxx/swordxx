...
int vm_lxx[] = {
  ...
  30, 52, 29, 12,
  // Joshua
  18, 24, 17, 24, 16, 27, 26, 35, 33, 42,
  23, 24, 32, 15, 64, 10, 18, 28, 54, 9,
  49, 34, 16, 36,
  // Judges
  ...
  22, 51, 39, 25,
  // I Kings
  53, 71, 28, 34, 32, 38, 51, 66, 28, 33,
  44, 54, 34, 31, 34, 42, 24, 46, 21, 29,
  43, 54,
  // II Kings
  ...
  31, 26, 33, 31, 26, 31, 31, 34, 35, 30,
  27, 25, 33, 24, 26, 20, 25, 25, 16, 29,
  30,
  // Psalms of Solomon
