 ...
 *
 * $Id: swcom.h,v 1.7 2001/10/24 19:38:02 chrislit Exp $
 *
...
public:
  ...
  */
  SWCom(const char *imodname = 0, const char *imoddesc = 0, SWDisplay * idisp = 0, char enc = ENC_UNKNOWN, char dir = DIRECTION_LTR, char mark = FMT_UNKNOWN);
  virtual ~SWCom();
