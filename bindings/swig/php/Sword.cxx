...
static pval _propget_SWConfig(zend_property_reference *property_reference);
...
static pval _propget_SWMgr(zend_property_reference *property_reference);
...
static pval _propget_SWModule(zend_property_reference *property_reference);
static int _propset_SWModule(zend_property_reference *property_reference, pval *value);

 #include "swkey.h"

static pval _propget_SW_POSITION(zend_property_reference *property_reference);
...
static pval _propget_SWKey(zend_property_reference *property_reference);
static int _propset_SWKey(zend_property_reference *property_reference, pval *value);

 #include "versekey.h"

static pval _propget_VerseKey(zend_property_reference *property_reference);
...
static pval _propget_ListKey(zend_property_reference *property_reference);
static int _propset_ListKey(zend_property_reference *property_reference, pval *value);

#include "treekey.h"

static pval _propget_TreeKey(zend_property_reference *property_reference);
static int _propset_TreeKey(zend_property_reference *property_reference, pval *value);

#include "treekeyidx.h"

static pval _propget_TreeKeyIdx(zend_property_reference *property_reference);
...
static pval _wrap_SWConfig_filename_get(zend_property_reference *property_reference) {
    ...
    
    {
        ...
        SWIG_SetPointerZval(return_value, (void *)resultobj, SWIGTYPE_p_string);
    }
...
static pval _wrap_SWConfig_Sections_get(zend_property_reference *property_reference) {
    ...
    
    {
        ...
        SWIG_SetPointerZval(return_value, (void *)resultobj, SWIGTYPE_p_SectionMap);
    }
    return _return_value;
}
...
ZEND_NAMED_FUNCTION(_wrap_new_SWConfig) {
    ...
    SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_SWConfig);
    //THIS IS IT!!!! munge this return value
    if (this_ptr) {
...
void __wrap_delete_SWConfig(zend_rsrc_list_entry *rsrc, const char *type_name TSRMLS_DC) {
    ...
    SWIG_ZTS_ConvertResourceData(rsrc->ptr,rsrc->type,type_name,(void **) &arg1,SWIGTYPE_p_SWConfig TSRMLS_CC);
...
static pval _propget_SWConfig(zend_property_reference *property_reference) {
  ...
  if (strcmp(propname,"Sections")==0) {
    return _wrap_SWConfig_Sections_get(property_reference);
  } else  if (strcmp(propname,"filename")==0) {
    return _wrap_SWConfig_filename_get(property_reference);
  } else  {
    //return it ourselves
    pval **_result;
...
static int _propset_SWConfig(zend_property_reference *property_reference, pval *value) {
  ...
  if (strcmp(propname,"filename")==0) {
    ...
    return add_property_zval_ex(property_reference->object,propname,Z_STRLEN_P(&(property->element)),value);
  }
}
...
ZEND_NAMED_FUNCTION(_wrap_SWMgr_findConfig) {
    ...
    arg1 = (char *) Z_STRVAL_PP(((0<argbase)?(&this_ptr):(args[0-argbase])));
    {
        if(SWIG_ConvertPtr(*args[1-argbase], (void **) &arg2, SWIGTYPE_p_p_char) < 0) {
            zend_error(E_ERROR, "Type error in argument %d of SWMgr_findConfig. Expected %s", 2-argbase, SWIGTYPE_p_p_char->name);
        }
    }
    {
...
static pval _wrap_SWMgr_Modules_get(zend_property_reference *property_reference) {
    ...
    
    {
        ...
        SWIG_SetPointerZval(return_value, (void *)resultobj, SWIGTYPE_p_ModMap);
    }
    return _return_value;
}
...
ZEND_NAMED_FUNCTION(_wrap_new_SWMgr) {
    ...
    SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_SWMgr);
    //THIS IS IT!!!! munge this return value
    if (this_ptr) {
        // NATIVE Constructor, use this_ptr
        zval *_cPtr; MAKE_STD_ZVAL(_cPtr);
...
void __wrap_delete_SWMgr(zend_rsrc_list_entry *rsrc, const char *type_name TSRMLS_DC) {
    ...
    // should we do type checking? How do I get SWIG_ type name?
    SWIG_ZTS_ConvertResourceData(rsrc->ptr,rsrc->type,type_name,(void **) &arg1,SWIGTYPE_p_SWMgr TSRMLS_CC);
...
ZEND_NAMED_FUNCTION(_wrap_SWMgr_getGlobalOptions) {
    ...
    
    {
        ...
        SWIG_SetPointerZval(return_value, (void *)resultobj, SWIGTYPE_p_OptionsList);
    }
}
...
ZEND_NAMED_FUNCTION(_wrap_SWMgr_module) {
    ...
    SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_SWModule);
    //THIS IS IT!!!! munge this return value
    {
        // ALTERNATIVE Constructor, make an object wrapper
        zval *obj, *_cPtr;
...
static pval _propget_SWMgr(zend_property_reference *property_reference) {
  ...
  if (strcmp(propname,"prefixPath")==0) {
    return _wrap_SWMgr_prefixPath_get(property_reference);
  } else  if (strcmp(propname,"configPath")==0) {
    return _wrap_SWMgr_configPath_get(property_reference);
  } else  if (strcmp(propname,"Modules")==0) {
    return _wrap_SWMgr_Modules_get(property_reference);
  } else  if (strcmp(propname,"config")==0) {
    return _wrap_SWMgr_config_get(property_reference);
  } else  if (strcmp(propname,"sysconfig")==0) {
    return _wrap_SWMgr_sysconfig_get(property_reference);
  } else  {
    //return it ourselves
    pval **_result;
    if (zend_hash_find(Z_OBJPROP_P(property_reference->object),propname,Z_STRLEN_P(&(property->element)),(void**)&_result)==SUCCESS) {
...
ZEND_NAMED_FUNCTION(_wrap_SWModule_getConfig) {
    ...
    SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_ConfigEntMap);
}
...
ZEND_NAMED_FUNCTION(_wrap_SWModule_Key) {
    ...
    SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_SWKey);
    //THIS IS IT!!!! munge this return value
    {
        // ALTERNATIVE Constructor, make an object wrapper
        zval *obj, *_cPtr;
...
ZEND_NAMED_FUNCTION(_wrap_SWModule_nullPercent) {
    ...
    arg1 = (char) *Z_STRVAL_PP(((0<argbase)?(&this_ptr):(args[0-argbase])));
    {
        if(SWIG_ConvertPtr(*args[1-argbase], (void **) &arg2, 0) < 0) {
            zend_error(E_ERROR, "Type error in argument %d of SWModule_nullPercent. Expected %s", 2-argbase, SWIGTYPE_p_void->name);
        }
    }
...
ZEND_NAMED_FUNCTION(_wrap_SWModule_Search) {
    ...
    if(arg_count > 5) {
        {
            if(SWIG_ConvertPtr(*args[5-argbase], (void **) &arg6, SWIGTYPE_p_bool) < 0) {
                zend_error(E_ERROR, "Type error in argument %d of SWModule_Search. Expected %s", 6-argbase, SWIGTYPE_p_bool->name);
            }
        }
    }
    if(arg_count > 6) {
    ...
    SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_ListKey);
    //THIS IS IT!!!! munge this return value
    {
        // ALTERNATIVE Constructor, make an object wrapper
        zval *obj, *_cPtr;
...
ZEND_NAMED_FUNCTION(_wrap_SWModule_getEntryAttributes) {
    ...
    SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_AttributeTypeList);
}
...
void __wrap_delete_SWModule(zend_rsrc_list_entry *rsrc, const char *type_name TSRMLS_DC) {
    ...
    // should we do type checking? How do I get SWIG_ type name?
    SWIG_ZTS_ConvertResourceData(rsrc->ptr,rsrc->type,type_name,(void **) &arg1,SWIGTYPE_p_SWModule TSRMLS_CC);
...
static pval _propget_SWModule(zend_property_reference *property_reference) {
  ...
  if (strcmp(propname,"terminateSearch")==0) {
    return _wrap_SWModule_terminateSearch_get(property_reference);
  } else  {
    //return it ourselves
    pval **_result;
    if (zend_hash_find(Z_OBJPROP_P(property_reference->object),propname,Z_STRLEN_P(&(property->element)),(void**)&_result)==SUCCESS) {
...
ZEND_NAMED_FUNCTION(_wrap_new_SW_POSITION) {
    ...
    SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_SW_POSITION);
    //THIS IS IT!!!! munge this return value
    if (this_ptr) {
        // NATIVE Constructor, use this_ptr
        zval *_cPtr; MAKE_STD_ZVAL(_cPtr);
...
void __wrap_delete_SW_POSITION(zend_rsrc_list_entry *rsrc, const char *type_name TSRMLS_DC) {
    ...
    // should we do type checking? How do I get SWIG_ type name?
    SWIG_ZTS_ConvertResourceData(rsrc->ptr,rsrc->type,type_name,(void **) &arg1,SWIGTYPE_p_SW_POSITION TSRMLS_CC);
...
static pval _propget_SW_POSITION(zend_property_reference *property_reference) {
  // No properties for base class SW_POSITION
  {
    //return it ourselves
    pval **_result;
    if (zend_hash_find(Z_OBJPROP_P(property_reference->object),propname,Z_STRLEN_P(&(property->element)),(void**)&_result)==SUCCESS) {
...
void __wrap_delete_SWKey(zend_rsrc_list_entry *rsrc, const char *type_name TSRMLS_DC) {
    ...
    // should we do type checking? How do I get SWIG_ type name?
    SWIG_ZTS_ConvertResourceData(rsrc->ptr,rsrc->type,type_name,(void **) &arg1,SWIGTYPE_p_SWKey TSRMLS_CC);
...
static pval _propget_SWKey(zend_property_reference *property_reference) {
  // No properties for base class SWKey
  {
    //return it ourselves
    pval **_result;
    if (zend_hash_find(Z_OBJPROP_P(property_reference->object),propname,Z_STRLEN_P(&(property->element)),(void**)&_result)==SUCCESS) {
...
ZEND_NAMED_FUNCTION(_wrap_new_VerseKey) {
    ...
    SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_VerseKey);
    //THIS IS IT!!!! munge this return value
    if (this_ptr) {
        // NATIVE Constructor, use this_ptr
        zval *_cPtr; MAKE_STD_ZVAL(_cPtr);
...
void __wrap_delete_VerseKey(zend_rsrc_list_entry *rsrc, const char *type_name TSRMLS_DC) {
    ...
    // should we do type checking? How do I get SWIG_ type name?
    SWIG_ZTS_ConvertResourceData(rsrc->ptr,rsrc->type,type_name,(void **) &arg1,SWIGTYPE_p_VerseKey TSRMLS_CC);
...
static pval _propget_VerseKey(zend_property_reference *property_reference) {
  ...
  {
    // chain to base class
    return _propget_SWKey(property_reference);
  }
}
...
static int _propset_VerseKey(zend_property_reference *property_reference, pval *value) {
  ...
  {
    // chain to base class
    return _propset_SWKey(property_reference, value);
  }
}
...
void __wrap_delete_ListKey(zend_rsrc_list_entry *rsrc, const char *type_name TSRMLS_DC) {
    ...
    // should we do type checking? How do I get SWIG_ type name?
    SWIG_ZTS_ConvertResourceData(rsrc->ptr,rsrc->type,type_name,(void **) &arg1,SWIGTYPE_p_ListKey TSRMLS_CC);
    ...
    if(arg_count > 1) {
        {
            if(SWIG_ConvertPtr(*args[1-argbase], (void **) &arg2, SWIGTYPE_p_int) < 0) {
                zend_error(E_ERROR, "Type error in argument %d of TreeKey_getUserData. Expected %s", 2-argbase, SWIGTYPE_p_int->name);
            }
        }
    }
...
static pval _propget_TreeKeyIdx(zend_property_reference *property_reference) {
  ...
  {
    // chain to base class
    return _propget_TreeKey(property_reference);
  }
}
...
static int _propset_TreeKeyIdx(zend_property_reference *property_reference, pval *value) {
  ...
  {
    // chain to base class
    return _propset_TreeKey(property_reference, value);
  }
}
...
ZEND_NAMED_FUNCTION(_wrap_new_LocaleMgr) {
    ...
    SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_LocaleMgr);
    //THIS IS IT!!!! munge this return value
    if (this_ptr) {
        // NATIVE Constructor, use this_ptr
        zval *_cPtr; MAKE_STD_ZVAL(_cPtr);
...
void __wrap_delete_LocaleMgr(zend_rsrc_list_entry *rsrc, const char *type_name TSRMLS_DC) {
    ...
    // should we do type checking? How do I get SWIG_ type name?
    SWIG_ZTS_ConvertResourceData(rsrc->ptr,rsrc->type,type_name,(void **) &arg1,SWIGTYPE_p_LocaleMgr TSRMLS_CC);
...
ZEND_NAMED_FUNCTION(_wrap_LocaleMgr_getLocale) {
    ...
    SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_SWLocale);
}
...
ZEND_NAMED_FUNCTION(_wrap_LocaleMgr_getAvailableLocales) {
    ...
    
    {
        ...
        SWIG_SetPointerZval(return_value, (void *)resultobj, SWIGTYPE_p_listTstring_t);
    }
}
...
static pval _propget_LocaleMgr(zend_property_reference *property_reference) {
  // No properties for base class LocaleMgr
  {
    //return it ourselves
    pval **_result;
    if (zend_hash_find(Z_OBJPROP_P(property_reference->object),propname,Z_STRLEN_P(&(property->element)),(void**)&_result)==SUCCESS) {
...
static pval _propget_SWFilterMgr(zend_property_reference *property_reference) {
  // No properties for base class SWFilterMgr
  {
    //return it ourselves
    pval **_result;
    if (zend_hash_find(Z_OBJPROP_P(property_reference->object),propname,Z_STRLEN_P(&(property->element)),(void**)&_result)==SUCCESS) {
...
ZEND_NAMED_FUNCTION(_wrap_new_SWText) {
    ...
    SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_SWText);
    //THIS IS IT!!!! munge this return value
    if (this_ptr) {
        // NATIVE Constructor, use this_ptr
        zval *_cPtr; MAKE_STD_ZVAL(_cPtr);
...
void __wrap_delete_SWText(zend_rsrc_list_entry *rsrc, const char *type_name TSRMLS_DC) {
    ...
    // should we do type checking? How do I get SWIG_ type name?
    SWIG_ZTS_ConvertResourceData(rsrc->ptr,rsrc->type,type_name,(void **) &arg1,SWIGTYPE_p_SWText TSRMLS_CC);
...
static pval _propget_SWText(zend_property_reference *property_reference) {
  ...
  {
    // chain to base class
    return _propget_SWModule(property_reference);
  }
}
...
static int _propset_SWText(zend_property_reference *property_reference, pval *value) {
  ...
  {
    // chain to base class
    return _propset_SWModule(property_reference, value);
  }
}
...
ZEND_NAMED_FUNCTION(_wrap_new_RawText) {
    ...
    SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_RawText);
    //THIS IS IT!!!! munge this return value
    if (this_ptr) {
        // NATIVE Constructor, use this_ptr
        zval *_cPtr; MAKE_STD_ZVAL(_cPtr);
...
void __wrap_delete_RawText(zend_rsrc_list_entry *rsrc, const char *type_name TSRMLS_DC) {
    ...
    // should we do type checking? How do I get SWIG_ type name?
    SWIG_ZTS_ConvertResourceData(rsrc->ptr,rsrc->type,type_name,(void **) &arg1,SWIGTYPE_p_RawText TSRMLS_CC);
...
static pval _propget_RawText(zend_property_reference *property_reference) {
  ...
  {
    // chain to base class
    return _propget_SWText(property_reference);
  }
}
...
static int _propset_RawText(zend_property_reference *property_reference, pval *value) {
  ...
  {
    // chain to base class
    return _propset_SWText(property_reference, value);
  }
}
...
ZEND_NAMED_FUNCTION(_wrap_new_zText) {
    ...
    SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_zText);
    //THIS IS IT!!!! munge this return value
    if (this_ptr) {
        // NATIVE Constructor, use this_ptr
        zval *_cPtr; MAKE_STD_ZVAL(_cPtr);
...
void __wrap_delete_zText(zend_rsrc_list_entry *rsrc, const char *type_name TSRMLS_DC) {
    ...
    // should we do type checking? How do I get SWIG_ type name?
    SWIG_ZTS_ConvertResourceData(rsrc->ptr,rsrc->type,type_name,(void **) &arg1,SWIGTYPE_p_zText TSRMLS_CC);
...
static pval _propget_RawCom(zend_property_reference *property_reference) {
  ...
  {
    // chain to base class
    return _propget_SWCom(property_reference);
  }
}
...
static int _propset_RawCom(zend_property_reference *property_reference, pval *value) {
  ...
  {
    // chain to base class
    return _propset_SWCom(property_reference, value);
  }
}
...
ZEND_NAMED_FUNCTION(_wrap_new_RawGenBook) {
    ...
    SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_RawGenBook);
    //THIS IS IT!!!! munge this return value
    if (this_ptr) {
        // NATIVE Constructor, use this_ptr
        zval *_cPtr; MAKE_STD_ZVAL(_cPtr);
...
void __wrap_delete_RawGenBook(zend_rsrc_list_entry *rsrc, const char *type_name TSRMLS_DC) {
    ...
    // should we do type checking? How do I get SWIG_ type name?
    SWIG_ZTS_ConvertResourceData(rsrc->ptr,rsrc->type,type_name,(void **) &arg1,SWIGTYPE_p_RawGenBook TSRMLS_CC);
...
static pval _propget_RawGenBook(zend_property_reference *property_reference) {
  ...
  {
    // chain to base class
    return _propget_SWGenBook(property_reference);
  }
}
...
static int _propset_RawGenBook(zend_property_reference *property_reference, pval *value) {
  ...
  {
    // chain to base class
    return _propset_SWGenBook(property_reference, value);
  }
}
...
ZEND_NAMED_FUNCTION(_wrap_new_SWLD) {
    ...
    SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_SWLD);
    //THIS IS IT!!!! munge this return value
    if (this_ptr) {
        // NATIVE Constructor, use this_ptr
        zval *_cPtr; MAKE_STD_ZVAL(_cPtr);
...
void __wrap_delete_SWLD(zend_rsrc_list_entry *rsrc, const char *type_name TSRMLS_DC) {
    ...
    // should we do type checking? How do I get SWIG_ type name?
    SWIG_ZTS_ConvertResourceData(rsrc->ptr,rsrc->type,type_name,(void **) &arg1,SWIGTYPE_p_SWLD TSRMLS_CC);
...
ZEND_NAMED_FUNCTION(_wrap_new_RawLD) {
    ...
    SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_RawLD);
    //THIS IS IT!!!! munge this return value
    if (this_ptr) {
        // NATIVE Constructor, use this_ptr
        zval *_cPtr; MAKE_STD_ZVAL(_cPtr);
...
void __wrap_delete_RawLD(zend_rsrc_list_entry *rsrc, const char *type_name TSRMLS_DC) {
    ...
    // should we do type checking? How do I get SWIG_ type name?
    SWIG_ZTS_ConvertResourceData(rsrc->ptr,rsrc->type,type_name,(void **) &arg1,SWIGTYPE_p_RawLD TSRMLS_CC);
...
static pval _propget_RawLD(zend_property_reference *property_reference) {
  ...
  {
    // chain to base class
    return _propget_SWLD(property_reference);
  }
}
...
static int _propset_RawLD(zend_property_reference *property_reference, pval *value) {
  ...
  {
    // chain to base class
    return _propset_SWLD(property_reference, value);
  }
}
...
ZEND_NAMED_FUNCTION(_wrap_new_RawLD4) {
    ...
    SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_RawLD4);
    //THIS IS IT!!!! munge this return value
    if (this_ptr) {
        // NATIVE Constructor, use this_ptr
        zval *_cPtr; MAKE_STD_ZVAL(_cPtr);
...
void __wrap_delete_RawLD4(zend_rsrc_list_entry *rsrc, const char *type_name TSRMLS_DC) {
    ...
    // should we do type checking? How do I get SWIG_ type name?
    SWIG_ZTS_ConvertResourceData(rsrc->ptr,rsrc->type,type_name,(void **) &arg1,SWIGTYPE_p_RawLD4 TSRMLS_CC);
...
ZEND_NAMED_FUNCTION(_wrap_new_zLD) {
    ...
    SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_zLD);
    //THIS IS IT!!!! munge this return value
    if (this_ptr) {
        // NATIVE Constructor, use this_ptr
        zval *_cPtr; MAKE_STD_ZVAL(_cPtr);
...
void __wrap_delete_zLD(zend_rsrc_list_entry *rsrc, const char *type_name TSRMLS_DC) {
    ...
    // should we do type checking? How do I get SWIG_ type name?
    SWIG_ZTS_ConvertResourceData(rsrc->ptr,rsrc->type,type_name,(void **) &arg1,SWIGTYPE_p_zLD TSRMLS_CC);
...
ZEND_NAMED_FUNCTION(_wrap_new_SWCompress) {
    ...
    SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_SWCompress);
    //THIS IS IT!!!! munge this return value
    if (this_ptr) {
        // NATIVE Constructor, use this_ptr
        zval *_cPtr; MAKE_STD_ZVAL(_cPtr);
...
void __wrap_delete_SWCompress(zend_rsrc_list_entry *rsrc, const char *type_name TSRMLS_DC) {
    ...
    // should we do type checking? How do I get SWIG_ type name?
    SWIG_ZTS_ConvertResourceData(rsrc->ptr,rsrc->type,type_name,(void **) &arg1,SWIGTYPE_p_SWCompress TSRMLS_CC);
    ...
    if(arg_count > 2) {
        {
            if(SWIG_ConvertPtr(*args[2-argbase], (void **) &arg3, SWIGTYPE_p_unsigned_long) < 0) {
                zend_error(E_ERROR, "Type error in argument %d of SWCompress_Buf. Expected %s", 3-argbase, SWIGTYPE_p_unsigned_long->name);
            }
        }
    }
...
ZEND_NAMED_FUNCTION(_wrap_SWCompress_zBuf) {
    ...
    }
    {
        if(SWIG_ConvertPtr(*args[1-argbase], (void **) &arg2, SWIGTYPE_p_unsigned_long) < 0) {
            zend_error(E_ERROR, "Type error in argument %d of SWCompress_zBuf. Expected %s", 2-argbase, SWIGTYPE_p_unsigned_long->name);
        }
    }
    if(arg_count > 2) {
        convert_to_string_ex(args[2-argbase]);
...
static pval _propget_SWCompress(zend_property_reference *property_reference) {
  // No properties for base class SWCompress
  {
    //return it ourselves
    pval **_result;
    if (zend_hash_find(Z_OBJPROP_P(property_reference->object),propname,Z_STRLEN_P(&(property->element)),(void**)&_result)==SUCCESS) {
...
ZEND_NAMED_FUNCTION(_wrap_new_LZSSCompress) {
    ...
    SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_LZSSCompress);
    //THIS IS IT!!!! munge this return value
    if (this_ptr) {
        // NATIVE Constructor, use this_ptr
        zval *_cPtr; MAKE_STD_ZVAL(_cPtr);
...
void __wrap_delete_LZSSCompress(zend_rsrc_list_entry *rsrc, const char *type_name TSRMLS_DC) {
    ...
    // should we do type checking? How do I get SWIG_ type name?
    SWIG_ZTS_ConvertResourceData(rsrc->ptr,rsrc->type,type_name,(void **) &arg1,SWIGTYPE_p_LZSSCompress TSRMLS_CC);
...
static pval _propget_LZSSCompress(zend_property_reference *property_reference) {
  ...
  {
    // chain to base class
    return _propget_SWCompress(property_reference);
  }
}
...
static int _propset_LZSSCompress(zend_property_reference *property_reference, pval *value) {
  ...
  {
    // chain to base class
    return _propset_SWCompress(property_reference, value);
  }
}
...
ZEND_NAMED_FUNCTION(_wrap_new_ZipCompress) {
    ...
    SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_ZipCompress);
    //THIS IS IT!!!! munge this return value
    if (this_ptr) {
        // NATIVE Constructor, use this_ptr
        zval *_cPtr; MAKE_STD_ZVAL(_cPtr);
...
void __wrap_delete_ZipCompress(zend_rsrc_list_entry *rsrc, const char *type_name TSRMLS_DC) {
    ...
    // should we do type checking? How do I get SWIG_ type name?
    SWIG_ZTS_ConvertResourceData(rsrc->ptr,rsrc->type,type_name,(void **) &arg1,SWIGTYPE_p_ZipCompress TSRMLS_CC);
...
INIT_OVERLOADED_CLASS_ENTRY(ce_swig_SWConfig,"swconfig",SWConfig_functions,NULL,_propget_SWConfig,_propset_SWConfig);
...
// Define class SWMgr
INIT_OVERLOADED_CLASS_ENTRY(ce_swig_SWMgr,"swmgr",SWMgr_functions,NULL,_propget_SWMgr,_propset_SWMgr);
...
INIT_OVERLOADED_CLASS_ENTRY(ce_swig_SWModule,"swmodule",SWModule_functions,NULL,_propget_SWModule,_propset_SWModule);
...
INIT_OVERLOADED_CLASS_ENTRY(ce_swig_SW_POSITION,"sw_position",SW_POSITION_functions,NULL,_propget_SW_POSITION,_propset_SW_POSITION);
...
// Define class SWKey
INIT_OVERLOADED_CLASS_ENTRY(ce_swig_SWKey,"swkey",SWKey_functions,NULL,_propget_SWKey,_propset_SWKey);
...
INIT_OVERLOADED_CLASS_ENTRY(ce_swig_VerseKey,"versekey",VerseKey_functions,NULL,_propget_VerseKey,_propset_VerseKey);
...
INIT_OVERLOADED_CLASS_ENTRY(ce_swig_ListKey,"listkey",ListKey_functions,NULL,_propget_ListKey,_propset_ListKey);
...
INIT_OVERLOADED_CLASS_ENTRY(ce_swig_TreeKey,"treekey",TreeKey_functions,NULL,_propget_TreeKey,_propset_TreeKey);
...
INIT_OVERLOADED_CLASS_ENTRY(ce_swig_TreeKeyIdx,"treekeyidx",TreeKeyIdx_functions,NULL,_propget_TreeKeyIdx,_propset_TreeKeyIdx);
...
INIT_OVERLOADED_CLASS_ENTRY(ce_swig_LocaleMgr,"localemgr",LocaleMgr_functions,NULL,_propget_LocaleMgr,_propset_LocaleMgr);
...
INIT_OVERLOADED_CLASS_ENTRY(ce_swig_SWFilterMgr,"swfiltermgr",SWFilterMgr_functions,NULL,_propget_SWFilterMgr,_propset_SWFilterMgr);
...
// Define class SWText
INIT_OVERLOADED_CLASS_ENTRY(ce_swig_SWText,"swtext",SWText_functions,NULL,_propget_SWText,_propset_SWText);
...
INIT_OVERLOADED_CLASS_ENTRY(ce_swig_RawText,"rawtext",RawText_functions,NULL,_propget_RawText,_propset_RawText);
...
// Define class zText
INIT_OVERLOADED_CLASS_ENTRY(ce_swig_zText,"ztext",zText_functions,NULL,_propget_zText,_propset_zText);
...
// Define class SWCom
INIT_OVERLOADED_CLASS_ENTRY(ce_swig_SWCom,"swcom",SWCom_functions,NULL,_propget_SWCom,_propset_SWCom);
...
// Define class RawCom
INIT_OVERLOADED_CLASS_ENTRY(ce_swig_RawCom,"rawcom",RawCom_functions,NULL,_propget_RawCom,_propset_RawCom);
...
// Define class zCom
INIT_OVERLOADED_CLASS_ENTRY(ce_swig_zCom,"zcom",zCom_functions,NULL,_propget_zCom,_propset_zCom);
...
INIT_OVERLOADED_CLASS_ENTRY(ce_swig_SWGenBook,"swgenbook",SWGenBook_functions,NULL,_propget_SWGenBook,_propset_SWGenBook);
...
INIT_OVERLOADED_CLASS_ENTRY(ce_swig_RawGenBook,"rawgenbook",RawGenBook_functions,NULL,_propget_RawGenBook,_propset_RawGenBook);
...
// Define class SWLD
INIT_OVERLOADED_CLASS_ENTRY(ce_swig_SWLD,"swld",SWLD_functions,NULL,_propget_SWLD,_propset_SWLD);
...
// Define class RawLD
INIT_OVERLOADED_CLASS_ENTRY(ce_swig_RawLD,"rawld",RawLD_functions,NULL,_propget_RawLD,_propset_RawLD);
...
// Define class RawLD4
INIT_OVERLOADED_CLASS_ENTRY(ce_swig_RawLD4,"rawld4",RawLD4_functions,NULL,_propget_RawLD4,_propset_RawLD4);
...
// Define class zLD
INIT_OVERLOADED_CLASS_ENTRY(ce_swig_zLD,"zld",zLD_functions,NULL,_propget_zLD,_propset_zLD);
...
INIT_OVERLOADED_CLASS_ENTRY(ce_swig_SWCompress,"swcompress",SWCompress_functions,NULL,_propget_SWCompress,_propset_SWCompress);
...
INIT_OVERLOADED_CLASS_ENTRY(ce_swig_LZSSCompress,"lzsscompress",LZSSCompress_functions,NULL,_propget_LZSSCompress,_propset_LZSSCompress);
...
INIT_OVERLOADED_CLASS_ENTRY(ce_swig_ZipCompress,"zipcompress",ZipCompress_functions,NULL,_propget_ZipCompress,_propset_ZipCompress);
