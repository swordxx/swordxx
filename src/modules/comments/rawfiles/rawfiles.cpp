...
RawFiles::RawFiles(const char *ipath, const char *iname, const char *idesc, SWDisplay *idisp, char enc, char dir, char mark) : RawVerse(ipath, O_RDWR), SWCom(iname, idesc, idisp, enc, dir, mark)
{
	versebuf = 0;
}
