...
SWText::SWText(const char *imodname, const char *imoddesc, SWDisplay *idisp, bool unicode, char dir): SWModule(imodname, imoddesc, idisp, "Biblical Texts", unicode, dir)
{
	delete key;
	key = CreateKey();
}
