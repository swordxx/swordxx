...
int vm_lxx[] = {
  // Genesis
  31, 25, 25, 26, 32, 23, 24, 22, 29, 32, 32, 20, 18, 24, 21, 16, 27, 33, 38, 18, 34, 24, 20, 67, 34, 35, 46, 22, 35, 44, 55, 33, 20, 31, 29, 43, 36, 30, 23, 23, 57, 38, 34, 34, 28, 34, 31, 22, 33, 26,
  // Exodus
  ...
  // Numbers
  54, 34, 51, 49, 31, 27, 89, 26, 23, 36, 35, 16, 34, 45, 41, 50, 28, 32, 22, 29, 35, 41, 30, 25, 18, 65, 23, 31, 39, 17, 54, 42, 56, 29, 34, 13,
  // Deuteronomy
  46, 37, 29, 49, 33, 25, 26, 20, 29, 22, 32, 32, 19, 29, 23, 22, 20, 22, 21, 20, 23, 30, 26, 24, 19, 19, 26, 69, 29, 20, 30, 52, 29, 12,
  // Joshua
  18, 24, 17, 24, 16, 27, 26, 35, 33, 42, 23, 24, 32, 15, 64, 10, 18, 28, 54, 9, 49, 34, 16, 36,
  // Judges
  36, 23, 31, 24, 32, 40, 25, 35, 57, 18, 40, 15, 25, 20, 20, 31, 13, 31, 30, 48, 25,
  // Ruth
  22, 23, 18, 22,
  // I Samuel
  28, 36, 21, 22, 12, 21, 17, 22, 27, 27, 15, 25, 23, 52, 35, 23, 54, 29, 24, 43, 16, 23, 28, 23, 44, 25, 12, 25, 11, 32, 13,
  // II Samuel
  27, 32, 39, 12, 26, 23, 29, 18, 13, 19, 27, 31, 39, 33, 37, 23, 29, 33, 44, 26, 22, 51, 39, 25,
  // I Kings
  53, 71, 28, 34, 32, 36, 51, 66, 28, 33, 43, 54, 34, 31, 34, 42, 24, 46, 21, 29, 43, 54,
  // II Kings
  22, 25, 27, 44, 27, 33, 20, 29, 37, 36, 21, 22, 25, 29, 38, 20, 41, 37, 37, 21, 26, 20, 37, 20, 30,
  // I Chronicles
  54, 55, 24, 43, 41, 81, 40, 40, 44, 14, 47, 41, 14, 17, 29, 43, 27, 17, 19, 8, 30, 19, 32, 31, 31, 32, 34, 21, 30,
  // II Chronicles
  18, 18, 17, 22, 14, 42, 22, 18, 31, 19, 23, 16, 23, 15, 19, 14, 19, 34, 11, 37, 20, 12, 21, 27, 28, 23, 9, 27, 36, 27, 21, 33, 25, 33, 31, 23,
  // I Esdras
  ...
  22, 23, 15, 17, 22, 14, 10, 17, 32, 13, 17, 7, 30, 19, 24, 24
  // Judith
  16, 28, 10, 15, 24, 21, 32, 36, 14, 23, 23, 20, 20, 19, 14, 25,
  // Tobit
  22, 14, 17, 21, 23, 19, 18, 21, 6, 14, 19, 22, 18, 15,
  // I Maccabees
  ...
  // Psalms
  6, 12, 9, 9, 13, 11, 18, 10, 39, 18, 9, 8, 7, 7, 11, 15, 51, 50, 14, 14, 32, 31, 10, 22, 22, 14, 14, 11, 13, 25, 24, 22, 23, 28, 28, 40, 40, 22, 18, 17, 13, 11, 27, 26, 17, 11, 15, 21, 23, 23, 19, 9, 9, 24, 23, 13, 12, 18, 17, 12, 13, 12, 11, 14, 20, 20, 36, 37, 36, 24, 24, 28, 28, 23, 13, 21, 72, 72, 20, 19, 16, 19, 18, 14, 17, 17, 19, 53, 52, 17, 16, 15, 23, 23, 13, 13, 12, 9, 9, 8, 29, 28, 35, 45, 48, 48, 43, 31, 31, 10, 10, 10, 26, 18, 19, 19, 29, 176, 176, 8, 9, 9, 8, 8, 6, 6, 6, 8, 8, 8, 18, 18, 3, 21, 26, 26, 9, 24, 24, 13, 10, 12, 15, 21, 21, 11, 20, 14, 9, 6, 7,
  // Prayer of Manasses
  15,
  // Proverbs
  35, 23, 38, 28, 23, 40, 27, 36, 25, 33, 31, 31, 27, 36, 38, 33, 30, 23, 29, 30, 31, 31, 36, 77, 31, 29, 29, 30, 49, 35, 31,
  // Ecclesiastes
  18, 26, 22, 17, 19, 12, 30, 17, 18, 20, 10, 14,
  // Song of Solomon
  17, 17, 11, 16, 17, 12, 14, 14,
  // Job
  22, 18, 26, 21, 27, 30, 21, 22, 35, 22, 20, 25, 28, 22, 35, 23, 16, 21, 29, 29, 34, 30, 17, 25, 6, 14, 23, 28, 25, 31, 40, 22, 33, 37, 16, 33, 24, 41, 35, 32, 26, 22,
  // Wisdom
  16, 24, 19, 20, 23, 25, 30, 21, 18, 21, 26, 27, 19, 31, 19, 29, 21, 25, 22,
  // Sirach
  30, 18, 31, 31, 15, 37, 36, 19, 18, 31, 34, 18, 26, 27, 20, 30, 32, 33, 30, 32, 28, 27, 28, 34, 26, 29, 30, 26, 28, 25, 31, 24, 40, 31, 26, 31, 31, 34, 35, 30, 27, 25, 33, 24, 26, 20, 25, 25, 16, 29, 30,
  // Psalms of Solomon
  8, 41, 16, 29, 22, 9, 10, 40, 20, 9, 9, 8, 12, 10, 15, 15, 51, 14,
  // Hosea
  11, 25, 5, 19, 15, 12, 16, 14, 17, 15, 12, 15, 15, 10,
  // Amos
  ...
  14, 17, 24, 6
  // Isaiah
  31, 21, 26, 6, 30, 13, 25, 23, 21, 34, 16, 6, 22, 32, 9, 14, 14, 7, 25, 6, 17, 25, 18, 23, 12, 21, 13, 29, 24, 33, 9, 20, 24, 17, 10, 22, 38, 22, 8, 31, 29, 25, 28, 28, 25, 13, 15, 22, 26, 11, 23, 15, 12, 17, 13, 11, 21, 14, 21, 22, 11, 12, 20, 12, 25, 24,
  // Jeremiah
  19, 37, 25, 31, 31, 30, 34, 23, 26, 25, 23, 17, 27, 22, 21, 21, 27, 23, 15, 18, 14, 30, 42, 10, 39, 28, 46, 64, 23, 33, 44, 38, 24, 22, 17, 32, 24, 40, 44, 13, 22, 19, 32, 21, 28, 18, 16, 18, 22, 13, 35, 34,
  // Baruch
  22, 35, 38, 37, 9,
  // Lamentations
  22, 22, 66, 22, 22,
