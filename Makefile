...
ACLOCAL = ${SHELL} /home/scribe/src/sword/missing --run aclocal
AUTOCONF = ${SHELL} /home/scribe/src/sword/missing --run autoconf
AUTOMAKE = ${SHELL} /home/scribe/src/sword/missing --run automake
...
localeDATA = locales.d/abbr.conf locales.d/da.conf locales.d/de.conf locales.d/es.conf locales.d/fr.conf locales.d/it.conf locales.d/no.conf locales.d/pt.conf
...
distclean-libtool:
	-rm -f libtool
$(srcdir)/Makefile.in: # Makefile.am $(srcdir)/locales.d/Makefile.am $(srcdir)/samples/Makefile.am $(top_srcdir)/configure.ac $(ACLOCAL_M4)
	cd $(top_srcdir) && \
...
testlib$(EXEEXT): $(testlib_OBJECTS) $(testlib_DEPENDENCIES) 
	@rm -f testlib$(EXEEXT)
	$(CXXLINK) $(testlib_LDFLAGS) $(testlib_OBJECTS) $(testlib_LDADD) $(LIBS)
