...
SWText::SWText(const char *imodname, const char *imoddesc, SWDisplay *idisp, char enc, char dir, char mark): SWModule(imodname, imoddesc, idisp, "Biblical Texts", enc, dir, mark)
{
	delete key;
	key = CreateKey();
}
