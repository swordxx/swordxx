...
XS(_wrap_SWMgr_findConfig) {
    ...
    if ((items < 3) || (items > 3)) {
        croak("Usage: SWMgr_findConfig(configType,prefixPath,configPath);");
    }
    if (!SvOK((SV*) ST(0))) arg1 = 0;
    else arg1 = (char *) SvPV(ST(0), PL_na);
    {
        if (SWIG_ConvertPtr(ST(1), (void **) &arg2, SWIGTYPE_p_p_char,0) < 0) {
            croak("Type error in argument 2 of SWMgr_findConfig. Expected %s", SWIGTYPE_p_p_char->name);
        }
    }
    {
...
XS(_wrap_SWModule_nullPercent) {
    ...
    if ((items < 2) || (items > 2)) {
        croak("Usage: SWModule_nullPercent(percent,userData);");
    }
    arg1 = (char) *SvPV(ST(0),PL_na);
    {
        if (SWIG_ConvertPtr(ST(1), (void **) &arg2, 0,0) < 0) {
            croak("Type error in argument 2 of SWModule_nullPercent. Expected %s", SWIGTYPE_p_void->name);
        }
    }
...
XS(_wrap_SWModule_createModule) {
    ...
    if ((items < 1) || (items > 1)) {
        croak("Usage: SWModule_createModule(char const *);");
    }
    if (!SvOK((SV*) ST(0))) arg1 = 0;
    else arg1 = (char *) SvPV(ST(0), PL_na);
...
XS(_wrap_LocaleMgr_systemLocaleMgr) {
    ...
    if ((items < 0) || (items > 0)) {
        croak("Usage: LocaleMgr_systemLocaleMgr();");
    }
...
XS(_wrap_RawText_createModule) {
    ...
    if ((items < 1) || (items > 1)) {
        croak("Usage: RawText_createModule(path);");
    }
    if (!SvOK((SV*) ST(0))) arg1 = 0;
    else arg1 = (char *) SvPV(ST(0), PL_na);
...
XS(_wrap_zText_createModule) {
    ...
    if ((items < 2) || (items > 2)) {
        croak("Usage: zText_createModule(path,blockBound);");
    }
    if (!SvOK((SV*) ST(0))) arg1 = 0;
    else arg1 = (char *) SvPV(ST(0), PL_na);
    arg2 = (int) SvIV(ST(1));
...
XS(_wrap_RawGenBook_createModule) {
    ...
    if ((items < 1) || (items > 1)) {
        croak("Usage: RawGenBook_createModule(ipath);");
    }
    if (!SvOK((SV*) ST(0))) arg1 = 0;
    else arg1 = (char *) SvPV(ST(0), PL_na);
...
XS(_wrap_RawLD_createModule) {
    ...
    if ((items < 1) || (items > 1)) {
        croak("Usage: RawLD_createModule(path);");
    }
    if (!SvOK((SV*) ST(0))) arg1 = 0;
    else arg1 = (char *) SvPV(ST(0), PL_na);
...
XS(_wrap_RawLD4_createModule) {
    ...
    if ((items < 1) || (items > 1)) {
        croak("Usage: RawLD4_createModule(path);");
    }
    if (!SvOK((SV*) ST(0))) arg1 = 0;
    else arg1 = (char *) SvPV(ST(0), PL_na);
...
XS(_wrap_zLD_createModule) {
    ...
    if ((items < 1) || (items > 1)) {
        croak("Usage: zLD_createModule(path);");
    }
    if (!SvOK((SV*) ST(0))) arg1 = 0;
    else arg1 = (char *) SvPV(ST(0), PL_na);
