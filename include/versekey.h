 ...
 *
 * $Id: versekey.h,v 1.22 2002/03/05 01:15:58 scribe Exp $
 *
...
public:
	...
	*/
	VerseKey & LowerBound(const char *lb, bool norecurse = false);
	...
	*/
	VerseKey & UpperBound(const char *ub, bool norecurse = false);
